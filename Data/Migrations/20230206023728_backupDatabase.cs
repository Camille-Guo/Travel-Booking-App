        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseConfirmationCode = table.Column<string>(type: "TEXT", nullable: false),
                    WhenPaid = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    LogoImageId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Airports_BlobDto_LogoImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightToAirport", x => new { x.AirportId, x.FlightId });
                    table.ForeignKey(
                        name: "FK_FlightToAirport_Airports_AirportId",
                        column: x => x.AirportId,
                        principalTable: "Airports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightToAirport_Flights_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlannedFlights_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchasedFlights_Flights_FlightId",
                        column: x => x.FlightId,
                        principalTable: "Flights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchasedFlights_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightToAirport_FlightId",
                table: "FlightToAirport",
                column: "FlightId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlannedFlights_UserId",
                table: "PlannedFlights",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasedFlights_FlightId",
                table: "PurchasedFlights",
                column: "FlightId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasedFlights_PurchaseId",
                table: "PurchasedFlights",
                column: "PurchaseId");
